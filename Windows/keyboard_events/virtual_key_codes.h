...
enum {
    ...
    kVK_ANSI_Comma                = VK_OEM_COMMA, // COMMA/LEFT TRIANGLE QUOTE key (0xBC)
...
enum {
    ...
    kVK_Backspace                 = VK_BACK, // BACKSPACE key (0x08)
    ...
    kVK_Help                      = VK_HELP, // HELP key (0x2F)
    kVK_Home                      = VK_HOME, // HOME key (0x24)
