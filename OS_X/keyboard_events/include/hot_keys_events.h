...
static const char *kPlayerFullScreenHotKeys = "PlayerFullScreenHotKeys";
static const char *kPlayerShuffleHotKeys = "PlayerShuffleHotKeys";
static const char *kPlayerSubtitlesHotKeys = "PlayerSubtitlesHotKeys";
...
static const char *kLeftDesktopHotKeys = "LeftDesktopHotKeys";                  // Ctrl, Left arrow
static const char *kRightDesktopHotKeys = "RightDesktopHotKeys";                // Ctrl, Right arrow
static const char *kOpenFileHotKeys = "OpenFileHotKeys";                        // Cmd, O
//  log out shortcut
