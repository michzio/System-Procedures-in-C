...
static const CFStringRef kSystemHotKeysPlist = CFSTR("Contents/Resources/system_hotkeys.plist");
static const CFStringRef kApplicationHotKeysPlist = CFSTR("Contents/Resources/application_hotkeys.plist");
...
void slide_show_blank_slide_white_hot_keys_event(void) {
    front_app_hot_keys_event(kSlideShowBlankSlideWhiteHotKeys, true);
}
